...
Say: could you please explain if 2 tenths or 4 hundredths is bigger and why? (Correct Answe: zero point two because 0.2 is bigger because when we divide a whole into hundredths the size of each piece is ten times smaller than if I divide by ten.)
