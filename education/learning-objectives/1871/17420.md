...
- Action:
  - If the answer given is incorrect, invoke the tool jumpToSlide with index 5.
  - If the answer is correct, invoke the tool moveToNextStep.
...
- Action:
  - Invoke the tool jumpToSlide with index 6.
