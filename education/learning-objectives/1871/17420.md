...
- Feedback and Action Instructions:
  - If the student gives the wrong answer or no answer is given, help the student to understand how the place value chart is used, then move to slide with index 6.
  - If the student gives the correct answer, give specific praise and move to slide with index 6.
