...
- Feedback:
  - If the answer given is incorrect, ask some guided questions to get the student to the correct answer.
- Action:
  - If the answer given is incorrect, jump to slide with index 4
  - If the answer given is correct, move to the next step.
